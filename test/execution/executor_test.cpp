...
// NOLINTNEXTLINE
TEST_F(ExecutorTest, DISABLED_SimpleIndexNestedLoopJoinTest) { ASSERT_EQ(true, false); }
...
// NOLINTNEXTLINE
TEST_F(ExecutorTest, DISABLED_SimpleLimitOffsetTest) { ASSERT_EQ(true, false); }
